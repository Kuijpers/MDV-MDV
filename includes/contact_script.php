...
$sWebsitenaam = "http://www.maaikedevries.nl.nl"; //vul hier de naam van jouw website in  

$sMail = "info@maaikedevries.nl"; //Het e-mailadres waarnaar de mail word gestuurd. Voor meerdere adressen, scheid de emailadressen met een comma.  
$bHTML = TRUE; //Bij TRUE word er een HTML-mail gestuurd. Bij FALSE een plain-text-mail  
$sOnderwerp = "Verzoek tot informatie via de website."; //Vul hier een onderwerp in. Dit word het onderwerp wanneer er geen ondewerp is opgegeven of als $bOnderwerp op TRUE staat  
...
Wij nemen deze zo snel mogelijk in behandeling.

Met vriendelijke groet,
Maaike de Vries Photography"; 
 
 //de tekst van het bedank mailtje  
$sBedanktfrom = "info@maaikedevries.nl"; //vanaf welk adres moet dit bedankmailtje verstuurd worden?  
$sBedanktsubj = "Bedankt voor uw email"; //dit is het onderwerp van het bedanktmailtje  
...
$sBedanktTxt = "Bedankt voor uw bericht. Wij zullen zo spoedig mogelijk contact opnemen"; //bedankt text  
